...
export default function HealthWarningPage({ step = 19 }: { step?: number }) {
    ...
    return (
        <div className="min-h-screen bg-[#EEF3FF] relative">
            ...
            <div className="container-responsive min-h-screen flex flex-col justify-center py-10">
                <div className="flex-1 flex flex-col items-center justify-center space-y-8">
                    ...
                    <div className="text-center px-6">
                        <h1 className="text-2xl font-semibold text-[#F4A623] mb-5" style={{ fontSize: '26px', lineHeight: '1.2' }}>
